...
export const PoolCL = new Factory(
  Contract.fromJson(
    PoolCLContractJson,
    "=132-2+9=1-3=2-1+4=3-6+cf=1-1=1+054=1+15=2+3=1-1=2+4=1-1+4fcf=2-2+7d=1-2=1+3c=2-2+6f=2-2+93=2-2+9f=2-2+c=1-3=2+e=1-1=2-2+f8=2-2=1-5=1-1=3-1+8=2-2+8c=3-1+e=1+3ba=1-1+3dd=1+41c=1+612=1-2+63a=1-3+748=1+7=1-2+a=2-2+90=6659-1+e=39-1+c=64+7a7e0214696e73657274206174206d617020706174683a2000=779-1+b=40+7a7e021472656d6f7665206174206d617020706174683a2000=423-1+2=117-1+f=40+7a7e0214696e73657274206174206d617020706174683a2000=895-1+b=61-1+f=38+7a7e0214696e73657274206174206d617020706174683a2000=31-1+d=209-1+b=38+7a7e021472656d6f7665206174206d617020706174683a2000=2372",
    "7d1f9cbe072484e0a7102c4fc6db3c7b4a53ea1a7c4088b20c32ce865011d70b",
    AllStructs
  )
);
